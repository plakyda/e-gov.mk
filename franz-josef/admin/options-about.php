<?php function franz_options_about() { ?>               
    ...
    <ol>
    	<li><?php _e( 'Width of the main content area is 848px.', 'franz-josef' ); ?></li>
    ...
    <p><?php printf( 'You can ask questions, request for help, provide suggestions, and report bugs at the %s.', '<a href="http://forum.graphene-theme.com/franz-josef/">' . __( 'Franz Josef Support Forum', 'franz-josef' ) . '</a>' ); ?></p>
