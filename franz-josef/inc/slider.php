                ...
                <div class="container">
                    <div class="carousel-caption">
						...
						<?php if (current_user_can ('level_7')) { ?>
                            ...
                            <p><a role="button" href="<?php the_permalink(); ?>" class="btn btn-lg btn-primary"><?php _e( 'Увійти', 'franz-josef' ); ?></a></p>
						<?php } ?>		
					   </div>
 ...
 */
function franz_exclude_slider_categories( $query ){
...
add_filter( 'pre_get_posts', 'franz_exclude_slider_categories' );
